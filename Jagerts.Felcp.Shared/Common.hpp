#pragma once
    ...
    #ifdef JAGERTS_FELCP_IO_ARCHIVE_DLL
        #define JAGERTS_FELCP_IO_ARCHIVE_API __declspec(dllexport)
    #else
        #define JAGERTS_FELCP_IO_ARCHIVE_API __declspec(dllimport)
    #endif
#else
    ...
    #define JAGERTS_FELCP_IO_ARCHIVE_API
#endif